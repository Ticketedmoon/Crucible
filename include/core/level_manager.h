...
class LevelManager
{
    ...
    public:
        ...
        static inline const std::string CATACOMB_MAIN_TILESET_PATH = "resources/maps/catacomb/mainlevbuild.png";
        static inline const std::string CATACOMB_DECORATIVE_TILESET_PATH = "resources/maps/catacomb/decorative.png";
        static inline const std::string CATACOMB_TORCH_TILESET_PATH = "resources/maps/catacomb/torch_1.png";
